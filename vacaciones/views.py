...
class ReintegroVacacionesListView(LoginRequiredMixin, ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        if es_secretaria(self.request.user) and funcionario and funcionario.jefe_inmediato:
            ...
            solicitudes_jefe = self._solicitudes_autorizadas_sin_reintegro(funcionario)
            funcionarios_data.append({
                'id': funcionario.pk,
            ...
            context["jefe_puede_crear"] = len(solicitudes_jefe) > 0
            context["jefe_solicitudes_autorizadas"] = json.dumps([
                {
                    'id': sol.pk,
                    'codigo_sabs': sol.codigo_sabs,
                    'fecha_inicio': sol.fecha_inicio_vacaciones.strftime('%d/%m/%Y'),
            ...
            context["secretaria_id"] = None
            context["jefe_puede_crear"] = False
            context["jefe_solicitudes_autorizadas"] = json.dumps([])
            context["jefe_id"] = None
...
__all__ = [
    ...
    "semaforo_cell",
    "semaforo_cell_reintegro",
    "aprobar_view",
    "devolver_view",
    "autorizar_view",
    "rechazar_view",
    "reenviar_view",
    "firmar_reintegro_view",
    "reenviar_reintegro_view",
    "aprobar_reintegro_view",
    "devolver_reintegro_view",
    "autorizar_reintegro_view",
    "rechazar_reintegro_view",
]
