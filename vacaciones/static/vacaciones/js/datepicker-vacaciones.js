document.addEventListener('DOMContentLoaded', function() {
  // Esperar a que las variables globales estén configuradas
  function inicializarDatepicker() {
    ...
    try {
      ...
      if (fechaInicioInput) {
        ...
        // Verificar si ya tiene una instancia de flatpickr
  ...
  function esperarVariablesYInicializar() {
    if (window.FESTIVOS_COLOMBIA && window.FESTIVOS_COLOMBIA.length > 0) {
      inicializarDatepicker();
    } else {
      setTimeout(esperarVariablesYInicializar, 200);
    }
  }
